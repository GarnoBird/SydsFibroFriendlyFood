...
const recipes = [
  ...
  },
  {
    ...
    energyLevel: "barely",
    equipment: ["none"],
    tags: ["low-fodmap-ish", "plain-seasoning", "gluten-free", "no-cook", "low-chop"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
  ...
  },
  {
    ...
    energyLevel: "little",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "plain-seasoning", "gluten-free", "omega-3", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
  ...
  },
  {
    ...
    energyLevel: "cook",
    equipment: ["pot", "pan"],
    tags: ["low-fodmap-ish", "plain-seasoning", "gluten-free", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
  ...
  {
    id: "fodmap-blueberry-chia-yogurt-bowl",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Blueberry Chia Yogurt Bowl",
    emoji: "🫐",
    goodWhen: "cold, soft breakfast sounds easiest.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["bowl"],
    tags: ["low-fodmap-ish", "lactose-free", "gluten-free", "soluble-fiber-friendly", "no-cook"],
    todayFilters: ["gentle", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["yogurt", "blueberries", "chia"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Strawberry Oat Yogurt Cup",
    emoji: "🍓",
    goodWhen: "a soft breakfast cup sounds good.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["bowl"],
    tags: ["low-fodmap-ish", "lactose-free", "soluble-fiber-friendly", "no-cook", "low-chop"],
    todayFilters: ["gentle", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["yogurt", "strawberries", "oats"],
    ingredients: ["Lactose-free yogurt", "Strawberries", "Quick oats", "Chia seeds optional"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Kiwi Peanut Butter Oats",
    emoji: "🥝",
    goodWhen: "oats need to feel a little more filling.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "soluble-fiber-friendly", "soft", "steady energy"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["oats", "kiwi", "peanutButter"],
    ingredients: ["Quick oats", "Water or lactose-free milk", "Kiwi", "Peanut butter", "Cinnamon optional"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Turkey Cucumber Rice Cakes",
    emoji: "🥒",
    goodWhen: "a cold no-cook lunch sounds best.",
    mealTypes: ["lunch", "snack"],
    foodTypes: ["chicken", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Salmon Cucumber Rice Cakes",
    emoji: "🐟",
    goodWhen: "fish and crunch sound okay.",
    mealTypes: ["lunch", "snack"],
    foodTypes: ["fish", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["none"],
    tags: ["low-fodmap-ish", "gluten-free", "omega-3", "no-cook", "low-chop"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat"],
    pantryItems: ["salmon", "riceCakes", "cucumber"],
    ingredients: ["Canned salmon or salmon pouch", "Plain rice cakes", "Cucumber", "Mayo or olive oil optional", "Salt"],
    steps: ["Open salmon.", "Put salmon on rice cakes.", "Add cucumber.", "Add mayo, olive oil, or salt if wanted."],
    easierVersion: "Eat salmon with rice cakes beside it.",
    fodmapNote: "Choose plain salmon."
  },
  {
    id: "fodmap-carrot-cheddar-rice-cakes",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Carrot Cheddar Rice Cakes",
    emoji: "🥕",
    goodWhen: "a crunchy snack plate can become lunch.",
    mealTypes: ["lunch", "snack"],
    foodTypes: ["snack", "veggie"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["none"],
    tags: ["low-fodmap-ish", "gluten-free", "no-cook", "low-chop"],
    todayFilters: ["gentle", "noBeans", "noWheat"],
    pantryItems: ["riceCakes", "carrots", "cheese"],
    ingredients: ["Plain rice cakes", "Carrot sticks or shredded carrot", "Cheddar optional", "Olive oil optional", "Salt"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Orange Tuna Rice Plate",
    emoji: "🍊",
    goodWhen: "tuna needs something bright beside it.",
    mealTypes: ["lunch", "snack"],
    foodTypes: ["fish", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "no-cook", "low-chop"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["tuna", "riceCakes", "orange"],
    ingredients: ["Tuna pouch or can", "Plain rice cakes", "Orange", "Mayo or olive oil optional", "Salt"],
    steps: ["Open tuna.", "Put rice cakes on the plate.", "Peel the orange.", "Add mayo, olive oil, or salt if wanted."],
    easierVersion: "Eat tuna and orange with rice cakes beside them.",
    fodmapNote: "Choose plain tuna and plain rice cakes."
  },
  {
    id: "fodmap-boiled-egg-potato-snack",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Boiled Egg Potato Snack",
    emoji: "🥚",
    goodWhen: "egg and potato sound steady.",
    mealTypes: ["breakfast", "lunch", "snack"],
    foodTypes: ["eggs", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "gluten-free", "soluble-fiber-friendly", "soft", "low-chop"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["eggs", "potato"],
    ingredients: ["Boiled egg", "Microwave potato", "Olive oil optional", "Salt"],
    steps: ["Warm the potato.", "Split or mash it.", "Slice or crumble the egg.", "Add olive oil or salt if wanted."],
    easierVersion: "Eat a boiled egg with a plain microwave potato.",
    fodmapNote: "Use a pre-boiled egg if that is easier."
  },
  {
    id: "fodmap-kiwi-yogurt-chia-cup",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Kiwi Yogurt Chia Cup",
    emoji: "🥝",
    goodWhen: "cold and soft sounds easier than cooking.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie", "snack"],
    timeMinutes: 5,
    energyLevel: "barely",
    equipment: ["bowl"],
    tags: ["low-fodmap-ish", "lactose-free", "soluble-fiber-friendly", "no-cook", "soft"],
    todayFilters: ["gentle", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["yogurt", "kiwi", "chia"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Chicken Carrot Rice Bowl",
    emoji: "🍚",
    goodWhen: "a warm bowl sounds grounding.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken", "veggie"],
    timeMinutes: 10,
    energyLevel: "little",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Turkey Potato Bowl",
    emoji: "🥔",
    goodWhen: "soft potato and turkey sound simple.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken", "veggie"],
    timeMinutes: 10,
    energyLevel: "little",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Salmon Potato Bowl",
    emoji: "🍠",
    goodWhen: "fish and potato sound warm and plain.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 10,
    energyLevel: "little",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "gluten-free", "omega-3", "soluble-fiber-friendly", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["salmon", "potato", "carrots"],
    ingredients: ["Canned salmon or cooked salmon", "Microwave potato", "Cooked carrots", "Olive oil", "Salt"],
    steps: ["Microwave the potato until soft.", "Split or mash it.", "Warm carrots if wanted.", "Put salmon beside or on the potato.", "Add olive oil and salt."],
    easierVersion: "Use salmon and potato only.",
    fodmapNote: "Choose plain salmon."
  },
  {
    id: "fodmap-white-fish-rice-bowl",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish White Fish Rice Bowl",
    emoji: "🐟",
    goodWhen: "soft fish and rice sound gentle.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 10,
    energyLevel: "little",
    ...
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["whiteFish", "rice", "spinach"],
    ingredients: ["Cooked white fish", "Microwave rice", "Spinach optional", "Olive oil", "Salt"],
    steps: ["Warm the rice.", "Warm fish.", "Warm spinach if wanted.", "Put fish on rice.", "Add olive oil and salt."],
    easierVersion: "Use fish and rice only.",
    fodmapNote: "Choose plain fish with simple seasoning."
  },
  {
    id: "fodmap-egg-carrot-rice-bowl",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Egg Carrot Rice Bowl",
    emoji: "🥕",
    goodWhen: "eggs and rice need a soft vegetable.",
    mealTypes: ["breakfast", "lunch"],
    foodTypes: ["eggs", "veggie"],
    timeMinutes: 10,
    energyLevel: "little",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "soluble-fiber-friendly", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["eggs", "rice", "carrots"],
    ingredients: ["Eggs", "Microwave rice", "Cooked carrots", "Olive oil", "Salt"],
    steps: ["Warm rice and carrots.", "Scramble or fry the eggs in a pan.", "Put eggs on the rice.", "Add olive oil and salt."],
    easierVersion: "Use a boiled egg over warm rice and carrots.",
    fodmapNote: "Keep seasonings plain."
  },
  {
    id: "fodmap-zucchini-egg-rice-bowl",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Zucchini Egg Rice Bowl",
    emoji: "🍳",
    goodWhen: "a simple egg bowl sounds possible.",
    mealTypes: ["breakfast", "lunch", "dinner"],
    foodTypes: ["eggs", "veggie"],
    timeMinutes: 10,
    energyLevel: "little",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "soft", "steady energy"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat"],
    pantryItems: ["eggs", "rice", "zucchini"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Tomato Egg Rice Bowl",
    emoji: "🍅",
    goodWhen: "eggs and tomato sound warm and soft.",
    mealTypes: ["breakfast", "lunch", "dinner"],
    foodTypes: ["eggs", "veggie"],
    timeMinutes: 10,
    energyLevel: "little",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Carrot Ginger Rice Soup",
    emoji: "🍲",
    goodWhen: "warm spoon food sounds calm.",
    mealTypes: ["lunch", "dinner", "snack"],
    foodTypes: ["soup", "veggie"],
    timeMinutes: 10,
    energyLevel: "little",
    equipment: ["pot"],
    tags: ["low-fodmap-ish", "gluten-free", "soluble-fiber-friendly", "soft", "warm"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["carrots", "rice", "ginger"],
    ingredients: ["Cooked carrots", "Cooked rice", "Ginger optional", "Garlic/onion-free broth", "Olive oil optional"],
    steps: ["Warm broth in a pot.", "Add carrots and rice.", "Add ginger if wanted.", "Simmer until warm.", "Add olive oil if wanted."],
    easierVersion: "Use carrots, rice, and warm broth only.",
    fodmapNote: "Choose garlic/onion-free broth."
  },
  {
    id: "fodmap-turkey-rice-noodle-cup",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Turkey Rice Noodle Cup",
    emoji: "🍜",
    goodWhen: "noodles and turkey sound easier than a plate.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken", "soup"],
    timeMinutes: 10,
    energyLevel: "little",
    equipment: ["kettle", "bowl"],
  ...
  {
    id: "fodmap-cinnamon-oat-kiwi-bowl",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Cinnamon Oat Kiwi Bowl",
    emoji: "🥣",
    goodWhen: "warm oats and fruit sound predictable.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie"],
    timeMinutes: 10,
    energyLevel: "little",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "soluble-fiber-friendly", "soft", "warm"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["oats", "kiwi", "chia"],
    ingredients: ["Quick oats", "Water or lactose-free milk", "Kiwi", "Chia seeds optional", "Cinnamon optional"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Chicken Cucumber Rice Cake Plate",
    emoji: "🧺",
    goodWhen: "cold chicken and rice cakes sound enough.",
    mealTypes: ["lunch", "snack"],
    foodTypes: ["chicken", "snack"],
    timeMinutes: 10,
    energyLevel: "little",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Chicken Rice Noodle Bowl",
    emoji: "🍜",
    goodWhen: "a warm noodle bowl sounds possible.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken"],
    timeMinutes: 15,
    energyLevel: "cook",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Salmon Rice Noodle Bowl",
    emoji: "🐟",
    goodWhen: "fish and noodles sound soft and warm.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 15,
    energyLevel: "cook",
    equipment: ["pot"],
    tags: ["low-fodmap-ish", "gluten-free", "omega-3", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["salmon", "riceNoodles", "spinach"],
    ingredients: ["Canned salmon or cooked salmon", "Rice noodles", "Spinach optional", "Olive oil", "Salt"],
    steps: ["Cook rice noodles.", "Warm salmon if wanted.", "Warm spinach if wanted.", "Mix noodles, salmon, and spinach.", "Add olive oil and salt."],
    easierVersion: "Use salmon and rice noodles only.",
    fodmapNote: "Choose plain salmon and plain rice noodles."
  },
  {
    id: "fodmap-turkey-egg-rice-skillet",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Turkey Egg Rice Skillet",
    emoji: "🍳",
    goodWhen: "a warm pan meal sounds doable.",
    mealTypes: ["breakfast", "lunch", "dinner"],
    foodTypes: ["chicken", "eggs"],
    timeMinutes: 15,
    energyLevel: "cook",
    equipment: ["pan", "microwave"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish White Fish Potato Carrot Plate",
    emoji: "🥔",
    goodWhen: "plain fish, potato, and carrots sound steady.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 15,
    energyLevel: "cook",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "soluble-fiber-friendly", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["whiteFish", "potato", "carrots"],
    ingredients: ["White fish", "Microwave potato", "Cooked carrots", "Olive oil", "Salt"],
    steps: ["Cook fish in an oiled pan until flaky.", "Microwave the potato until soft.", "Warm carrots.", "Split or mash the potato.", "Add olive oil and salt."],
    easierVersion: "Use cooked fish and a microwave potato.",
    fodmapNote: "Choose plain fish with simple seasoning."
  },
  {
    id: "fodmap-shrimp-rice-bowl",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Shrimp Rice Bowl",
    emoji: "🍤",
    goodWhen: "shrimp and rice sound light but real.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 15,
    energyLevel: "cook",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "soft", "steady energy"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["shrimp", "rice", "spinach"],
    ingredients: ["Shrimp", "Microwave rice", "Spinach optional", "Olive oil", "Salt"],
    steps: ["Warm the rice.", "Cook shrimp in an oiled pan until pink.", "Warm spinach if wanted.", "Put shrimp on rice.", "Add salt."],
    easierVersion: "Use cooked shrimp and microwave rice.",
    fodmapNote: "Choose plain shrimp."
  },
  {
    id: "fodmap-chicken-zucchini-rice-skillet",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Chicken Zucchini Rice Skillet",
    emoji: "🍗",
    goodWhen: "a simple skillet meal sounds possible.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken", "veggie"],
    timeMinutes: 15,
    energyLevel: "cook",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Egg Quinoa Carrot Bowl",
    emoji: "🥚",
    goodWhen: "eggs and quinoa sound like a real bowl.",
    mealTypes: ["breakfast", "lunch"],
    foodTypes: ["eggs", "veggie"],
    timeMinutes: 15,
    energyLevel: "cook",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "soluble-fiber-friendly", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["eggs", "quinoa", "carrots"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Turkey Quinoa Spinach Bowl",
    emoji: "🥣",
    goodWhen: "a warm turkey bowl sounds useful.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken", "veggie"],
    timeMinutes: 15,
    energyLevel: "cook",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Salmon Quinoa Cucumber Bowl",
    emoji: "🥒",
    goodWhen: "a cool salmon bowl sounds okay.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 15,
    energyLevel: "cook",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "gluten-free", "omega-3", "steady energy"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat"],
    pantryItems: ["salmon", "quinoa", "cucumber"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Rice Noodle Carrot Soup",
    emoji: "🍜",
    goodWhen: "warm noodles and carrots sound gentle.",
    mealTypes: ["lunch", "dinner", "snack"],
    foodTypes: ["soup", "veggie"],
    timeMinutes: 15,
    energyLevel: "cook",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "soluble-fiber-friendly", "soft", "warm"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["riceNoodles", "carrots"],
    ingredients: ["Rice noodles", "Cooked carrots", "Garlic/onion-free broth", "Spinach optional", "Salt"],
    steps: ["Warm broth in a pot.", "Add rice noodles.", "Add carrots.", "Simmer until noodles are soft.", "Add spinach if wanted."],
    easierVersion: "Use rice noodles and warm broth only.",
    fodmapNote: "Choose garlic/onion-free broth."
  },
  {
    id: "fodmap-potato-spinach-egg-hash",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Potato Spinach Egg Hash",
    emoji: "🍳",
    goodWhen: "potato and egg sound like a steady meal.",
    mealTypes: ["breakfast", "lunch", "dinner"],
    foodTypes: ["eggs", "veggie"],
    timeMinutes: 15,
    energyLevel: "cook",
  ...
  {
    id: "fodmap-future-chicken-rice-cups",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Chicken Rice Cups",
    emoji: "📦",
    goodWhen: "future lunches need to be automatic.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken"],
    timeMinutes: 25,
    energyLevel: "future",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Turkey Potato Boxes",
    emoji: "📦",
    goodWhen: "future meals need soft potato and turkey.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["chicken", "veggie"],
    timeMinutes: 25,
    energyLevel: "future",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Salmon Rice Boxes",
    emoji: "📦",
    goodWhen: "future fish bowls would help.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["fish"],
    timeMinutes: 25,
    energyLevel: "future",
    equipment: ["microwave"],
    tags: ["low-fodmap-ish", "gluten-free", "omega-3", "leftovers", "soluble-fiber-friendly"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["salmon", "rice", "carrots"],
    ingredients: ["Cooked salmon or canned salmon", "Cooked rice", "Cooked carrots", "Olive oil", "Salt"],
    steps: ["Warm rice and carrots.", "Add salmon.", "Pack into containers.", "Add olive oil and salt."],
    easierVersion: "Pack salmon and microwave rice together.",
    fodmapNote: "Choose plain salmon."
  },
  {
    id: "fodmap-future-egg-potato-squares",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Egg Potato Squares",
    emoji: "🥚",
    goodWhen: "soft egg bites for later sound useful.",
    mealTypes: ["breakfast", "lunch", "snack"],
    foodTypes: ["eggs"],
    ...
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["eggs", "potato", "spinach"],
    ingredients: ["Eggs", "Microwave potato", "Spinach optional", "Olive oil", "Salt"],
    steps: ["Heat oven to 350 F.", "Oil a baking dish.", "Add soft potato pieces and spinach if wanted.", "Pour beaten eggs over the top.", "Bake for 20 to 25 minutes, until set.", "Cool a little and cut into squares."],
    easierVersion: "Make scrambled eggs with microwave potato instead.",
    fodmapNote: "Keep seasonings plain."
  },
  {
    id: "fodmap-future-carrot-rice-soup-base",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Carrot Rice Soup Base",
    emoji: "🍲",
    goodWhen: "future warm soup would help.",
    mealTypes: ["lunch", "dinner", "snack"],
    foodTypes: ["soup", "veggie"],
    timeMinutes: 25,
    energyLevel: "future",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "leftovers", "soluble-fiber-friendly", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["carrots", "rice"],
    ingredients: ["Cooked carrots", "Cooked rice", "Garlic/onion-free broth", "Olive oil optional", "Salt"],
    steps: ["Warm broth in a pot.", "Add carrots and rice.", "Simmer until soft and warm.", "Pack some for later.", "Add olive oil or salt when serving."],
    easierVersion: "Warm broth with rice and carrots only.",
    fodmapNote: "Choose garlic/onion-free broth."
  },
  {
    id: "fodmap-future-breakfast-oat-jars",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Breakfast Oat Jars",
    emoji: "🥣",
    goodWhen: "future breakfasts need less deciding.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie"],
    timeMinutes: 5,
    energyLevel: "future",
    equipment: ["jar"],
    tags: ["low-fodmap-ish", "lactose-free", "leftovers", "soluble-fiber-friendly", "no-cook"],
    todayFilters: ["gentle", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["oats", "chia", "milk"],
    ingredients: ["Quick oats", "Chia seeds optional", "Lactose-free milk", "Blueberries or strawberries", "Cinnamon optional"],
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Kiwi Chia Yogurt Jars",
    emoji: "🥝",
    goodWhen: "cold breakfast jars would be helpful.",
    mealTypes: ["breakfast", "snack"],
    foodTypes: ["smoothie"],
    timeMinutes: 5,
    energyLevel: "future",
  ...
  },
  {
    ...
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Chicken Rice Noodle Soup Kits",
    emoji: "📦",
    goodWhen: "future soup needs to be mostly assembled.",
    mealTypes: ["lunch", "dinner"],
    foodTypes: ["soup", "chicken"],
    timeMinutes: 25,
    energyLevel: "future",
  ...
  {
    id: "fodmap-future-potato-carrot-egg-squares",
    recipeMode: "fodmap",
    title: "Low-FODMAP-ish Future Potato Carrot Egg Squares",
    emoji: "🥕",
    goodWhen: "soft egg squares with vegetables sound useful.",
    mealTypes: ["breakfast", "lunch", "snack"],
    foodTypes: ["eggs", "veggie"],
    timeMinutes: 25,
    energyLevel: "future",
    ...
    tags: ["low-fodmap-ish", "gluten-free", "leftovers", "soluble-fiber-friendly", "soft"],
    todayFilters: ["gentle", "noDairy", "noBeans", "noWheat", "noRawVeg"],
    pantryItems: ["eggs", "potato", "carrots"],
    ingredients: ["Eggs", "Microwave potato", "Cooked carrots", "Olive oil", "Salt"],
    steps: ["Heat oven to 350 F.", "Oil a baking dish.", "Add soft potato pieces and carrots.", "Pour beaten eggs over the top.", "Bake for 20 to 25 minutes, until set.", "Cool a little and cut into squares."],
    easierVersion: "Make scrambled eggs with potato and carrots instead.",
    fodmapNote: "Keep seasonings plain."
  }
];
